...
export const TALK = {
  ...
  HOT: {
    ...
    any: [L('手气来了挡都挡不住。', 2), L('看到了吗？', 1), L('这局我说了算。', 2)],
  },
  ...
  FLOW: {
    ...
    any: [L('顺。', 1), L('继续。', 1), L('没什么好解释的。', 1)],
  },
};

/** 赢下一手之后的得意台词（按状态抽）。 */
export const WIN_QUIP = {
  FLOW: [L('意料之中。', 1), L('我说过，今天是我的。', 2)],
  HOT: [L('看见没？手风来了挡不住。', 2), L('哈哈哈哈！再来！', 2), L('我就说吧。', 2)],
  CALM: [L('收了。', 1), L('这手该我赢。', 1)],
  SHAKEN: [L('总算赢一把。', 1), L('……我就说没问题。', 1)],
  TILT: [L('早该如此！', 2), L('看清楚，这才是我。', 2)],
  BREAKING: [L('我……我还能赢。', 0), L('别别得意太早。', 2)],
};

/** 抽一句赢牌后的臭屁话；返回 null 表示这把保持沉默。 */
...
export const SPEECH_REACT = {
  taunt: {
    ...
    HOT: { hit: '行，那我就凶给你看。', resist: '激将法对我？晚了，手气在这。' },
    FLOW: { hit: '嗯。', resist: '你说完了吗？发牌。' },
  },
  pressure: {
    ...
    HOT: { hit: '……这一手让你。', resist: '我不退，今天谁说都没用。' },
    FLOW: { hit: '继续。', resist: '你的声音在发抖。' },
  },
  challenge: {
    // 质疑命中（确实存在矛盾）
    ...
    HOT: { hit: '你——！热身而已！', resist: '看得准又如何，手风在我这。' },
    FLOW: { hit: '……随你。', resist: '这一手，你自己心里有数。' },
    // 落空
    whiff: '就这？我还以为你抓到了什么。',
  },
};
